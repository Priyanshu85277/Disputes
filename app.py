...
# YOLO models
model = YOLO(r'C:\Users\DEEPANSHU\OneDrive\Desktop\sih\best4.pt')
...
def predict():
    try:
        ...
        results = model.predict(source=upload_path, conf=0.25, save=True ,hide_boundingbox=True,hide_conf=True,save_crop=True)
        ...
        for result in results:
            ...
            output_image_path = os.path.join(output_dir, upload_path)
